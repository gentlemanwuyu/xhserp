                    ...
                    <div class="layui-col-xs4">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <span class="erp-form-span">{{$supplier->name}}</span>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">结余金额</label>
                            <div class="layui-input-block">
                                <span class="erp-form-span">{{$supplier->total_remained_amount}}</span>
                            </div>
                        </div>
                        <div class="layui-form-item">
...
@section('scripts')
    <script>
        var users = <?= json_encode($users); ?>
                ...
                ,total_remained_amount = <?= json_encode($supplier->total_remained_amount); ?>;
        layui.use(['form', 'table'], function () {
            var form = layui.form
                    ,table = layui.table
                    ,tableIns = table.render({
                elem: '#detail'
                ,data: <?= json_encode($supplier->unpaid_items); ?>
                ,page: false
                ,totalRow: true
                ,cols: [
                    [
