...
class RouteServiceProvider extends ServiceProvider
{
	...
	{
		$router->group(['namespace' => $this->namespace, 'middleware' => ['web', 'auth'], 'prefix'=>'purchase', 'as'=>'purchase::'], function($router)
		{
			require (config('modules.path').'/Purchase/Http/routes.php');
		});
	}
}
