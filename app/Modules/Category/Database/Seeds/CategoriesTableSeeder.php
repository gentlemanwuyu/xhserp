...
class CategoriesTableSeeder extends Seeder
{
    ...
    protected function seedProductCategory()
    {
        ...
        $vertical_switch = Category::create(['name' => '立式液位开关', 'parent_id' => $level_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PP立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PVDF立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '304立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::PRODUCT]);
        $horizontal_switch = Category::create(['name' => '卧式液位开关', 'parent_id' => $level_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PP卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PVDF卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '304卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::PRODUCT]);

        //流量计配件
        $flowmeter_parts = Category::create(['name' => '流量计配件', 'type' => Category::PRODUCT]);
        $tube = Category::create(['name' => '视管', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PC视管', 'parent_id' => $tube->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PVC视管', 'parent_id' => $tube->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PSU视管', 'parent_id' => $tube->id, 'type' => Category::PRODUCT]);
        $rotor = Category::create(['name' => '转子', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '304转子', 'parent_id' => $rotor->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '316转子', 'parent_id' => $rotor->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '铁氟龙转子', 'parent_id' => $rotor->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '钛转子', 'parent_id' => $rotor->id, 'type' => Category::PRODUCT]);
        $guide = Category::create(['name' => '导轨', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '316导轨', 'parent_id' => $guide->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '碳纤棒导轨', 'parent_id' => $guide->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '螺母', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        $joint = Category::create(['name' => '接头', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PVC接头', 'parent_id' => $joint->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PP接头', 'parent_id' => $joint->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '指示扣', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        $apron = Category::create(['name' => '流量计胶圈', 'parent_id' => $flowmeter_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'EPDM胶圈', 'parent_id' => $apron->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '铁氟龙胶圈', 'parent_id' => $apron->id, 'type' => Category::PRODUCT]);

        // 滚轮片
        $disk = Category::create(['name' => '滚轮片', 'type' => Category::PRODUCT]);
        Category::create(['name' => 'PP滚轮片', 'parent_id' => $disk->id, 'type' => Category::PRODUCT]);
        ...
        Category::create(['name' => '孟山都滚轮片', 'parent_id' => $disk->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '耐高温滚轮片', 'parent_id' => $disk->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => 'LCD滚轮', 'parent_id' => $disk->id, 'type' => Category::PRODUCT]);

        // 连接套
        $connect = Category::create(['name' => '连接套', 'type' => Category::PRODUCT]);
        Category::create(['name' => '卡环', 'parent_id' => $connect->id, 'type' => Category::PRODUCT]);
        ...
        Category::create(['name' => '卡扣', 'parent_id' => $cup->id, 'type' => Category::PRODUCT]);
        ...
        Category::create(['name' => '喷嘴芯', 'parent_id' => $nozzle_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '底座', 'parent_id' => $nozzle_parts->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '叶轮', 'parent_id' => $nozzle_parts->id, 'type' => Category::PRODUCT]);
        ...
        // 喷管接口
        $interface = Category::create(['name' => '喷管接口', 'type' => Category::PRODUCT]);
        ...
        Category::create(['name' => 'EPDM胶圈', 'parent_id' => $rubber_gasket->id, 'type' => Category::PRODUCT]);
        Category::create(['name' => '铁氟龙胶圈', 'parent_id' => $rubber_gasket->id, 'type' => Category::PRODUCT]);
    ...
    protected function seedGoodsCategory()
    {
        ...
        $vertical_switch = Category::create(['name' => '立式液位开关', 'parent_id' => $level_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => 'PP立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => 'PVDF立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => '304立式液位开关', 'parent_id' => $vertical_switch->id, 'type' => Category::GOODS]);
        $horizontal_switch = Category::create(['name' => '卧式液位开关', 'parent_id' => $level_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => 'PP卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => 'PVDF卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::GOODS]);
        Category::create(['name' => '304卧式液位开关', 'parent_id' => $horizontal_switch->id, 'type' => Category::GOODS]);
        ...
        // 连接套
        $connect = Category::create(['name' => '连接套', 'type' => Category::GOODS]);
        Category::create(['name' => '卡环', 'parent_id' => $connect->id, 'type' => Category::GOODS]);

        // 固定套
        $fixed = Category::create(['name' => '固定套', 'type' => Category::GOODS]);

        // 插件
        $cup = Category::create(['name' => '插件', 'type' => Category::GOODS]);
        Category::create(['name' => '卡扣', 'parent_id' => $cup->id, 'type' => Category::GOODS]);
        ...
        Category::create(['name' => '喷嘴芯', 'parent_id' => $nozzle->id, 'type' => Category::GOODS]);
        ...
        Category::create(['name' => 'EPDM胶圈', 'parent_id' => $rubber_gasket->id, 'type' => Category::GOODS]);
        Category::create(['name' => '铁氟龙胶圈', 'parent_id' => $rubber_gasket->id, 'type' => Category::GOODS]);
