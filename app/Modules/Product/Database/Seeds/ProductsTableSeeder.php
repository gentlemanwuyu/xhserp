...
class ProductsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        Inventory::create(['sku_id' => $p1_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $p2_s1->id, 'stock' => 32, 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p2_s2 = ProductSku::create(['product_id' => $p2->id, 'code' => 'xhsylbsus304002-7kg', 'weight' => 68.5, 'cost_price' => 15.8,]);
        Inventory::create(['sku_id' => $p2_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p2_s3 = ProductSku::create(['product_id' => $p2->id, 'code' => 'xhsylbsus304002-10kg', 'weight' => 70.8, 'cost_price' => 16.8,]);
        Inventory::create(['sku_id' => $p2_s3->id, 'stock' => 48, 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $p3_s1->id, 'stock' => 12, 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p3_s2 = ProductSku::create(['product_id' => $p3->id, 'code' => 'xhsylbpp001-7kg', 'weight' => 72.5, 'cost_price' => 30.8,]);
        Inventory::create(['sku_id' => $p3_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p3_s3 = ProductSku::create(['product_id' => $p3->id, 'code' => 'xhsylbpp001-10kg', 'weight' => 78.8, 'cost_price' => 132.8,]);
        Inventory::create(['sku_id' => $p3_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $p4_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p4_s2 = ProductSku::create(['product_id' => $p4->id, 'code' => 'xhsylbpp002-7kg', 'weight' => 88.5, 'cost_price' => 36.8,]);
        Inventory::create(['sku_id' => $p4_s2->id, 'stock' => 46, 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p4_s3 = ProductSku::create(['product_id' => $p4->id, 'code' => 'xhsylbpp002-10kg', 'weight' => 93.8, 'cost_price' => 38.8,]);
        Inventory::create(['sku_id' => $p4_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $p5_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p5_s2 = ProductSku::create(['product_id' => $p5->id, 'code' => 'xhsylbpp002-7kg', 'weight' => 88.5, 'cost_price' => 36.8,]);
        Inventory::create(['sku_id' => $p5_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $p5_s3 = ProductSku::create(['product_id' => $p5->id, 'code' => 'xhsylbpp002-10kg', 'weight' => 93.8, 'cost_price' => 38.8,]);
        Inventory::create(['sku_id' => $p5_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $s1_s1->id, 'stock' => 80, 'highest_stock' => 500, 'lowest_stock' => 100]);
        $s1_s2 = ProductSku::create(['product_id' => $s1->id, 'code' => 'xhsywkgpp011-10m', 'weight' => 230.5, 'cost_price' => 11.8,]);
        Inventory::create(['sku_id' => $s1_s2->id, 'stock' => 56, 'highest_stock' => 500, 'lowest_stock' => 100]);
        $s1_s3 = ProductSku::create(['product_id' => $s1->id, 'code' => 'xhsywkgpp011-15m', 'weight' => 230.8, 'cost_price' => 18.8,]);
        Inventory::create(['sku_id' => $s1_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 100]);
        ...
        Inventory::create(['sku_id' => $d1_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $d1_s2 = ProductSku::create(['product_id' => $d1->id, 'code' => 'xhslppp124b', 'weight' => 25, 'cost_price' => 0.2,]);
        Inventory::create(['sku_id' => $d1_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $d1_s3 = ProductSku::create(['product_id' => $d1->id, 'code' => 'xhslppp124c', 'weight' => 25, 'cost_price' => 0.2,]);
        Inventory::create(['sku_id' => $d1_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $d3_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $d3_s2 = ProductSku::create(['product_id' => $d3->id, 'code' => 'xhslpngwa173b', 'weight' => 25, 'cost_price' => 1.2,]);
        Inventory::create(['sku_id' => $d3_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $d4_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $d4_s2 = ProductSku::create(['product_id' => $d4->id, 'code' => 'xhslpbj159b', 'weight' => 40, 'cost_price' => 0.8,]);
        Inventory::create(['sku_id' => $d4_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $d4_s3 = ProductSku::create(['product_id' => $d4->id, 'code' => 'xhslpbj159c', 'weight' => 40, 'cost_price' => 0.8,]);
        Inventory::create(['sku_id' => $d4_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $d5_s1->id, 'stock' => 2300, 'highest_stock' => 5000, 'lowest_stock' => 1000]);
        $d5_s2 = ProductSku::create(['product_id' => $d5->id, 'code' => 'xhslptj144gjb', 'weight' => 40, 'cost_price' => 0.25,]);
        Inventory::create(['sku_id' => $d5_s2->id, 'stock' => 1500, 'highest_stock' => 5000, 'lowest_stock' => 1000]);
        $d5_s3 = ProductSku::create(['product_id' => $d5->id, 'code' => 'xhslptj144gjc', 'weight' => 40, 'cost_price' => 0.25,]);
        Inventory::create(['sku_id' => $d5_s3->id, 'stock' => 786, 'highest_stock' => 5000, 'lowest_stock' => 1000]);
        ...
        Inventory::create(['sku_id' => $r1_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 5000, 'lowest_stock' => 1000]);
        $r1_s2 = ProductSku::create(['product_id' => $r1->id, 'code' => 'xhslptj144jqtpv', 'weight' => 40, 'cost_price' => 0.25,]);
        Inventory::create(['sku_id' => $r1_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 5000, 'lowest_stock' => 1000]);
        ...
        Inventory::create(['sku_id' => $r2_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $r2_s2 = ProductSku::create(['product_id' => $r2->id, 'code' => 'xhspz565jqtpv', 'weight' => 40, 'cost_price' => 0.25,]);
        Inventory::create(['sku_id' => $r2_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        ...
        Inventory::create(['sku_id' => $n2_s1->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $n2_s2 = ProductSku::create(['product_id' => $n2->id, 'code' => 'xhspz565bottomb', 'weight' => 40, 'cost_price' => 0.8,]);
        Inventory::create(['sku_id' => $n2_s2->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
        $n2_s3 = ProductSku::create(['product_id' => $n2->id, 'code' => 'xhspz565bottomc', 'weight' => 40, 'cost_price' => 0.8,]);
        Inventory::create(['sku_id' => $n2_s3->id, 'stock' => mt_rand(50, 500), 'highest_stock' => 500, 'lowest_stock' => 50]);
